export default function TestimonialCard({ testimonial, index }: any) {
  return (
    <>
      <div
        key={index}
        className="flex flex-col max-w-md   mx-4 mb-card mt-card shadow-lg"
      >
        <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-gray-50">
          <p className="relative px-6 py-1 text-lg italic text-center text-gray-800">
            <svg
              ...
              viewBox="0 0 512 512"
              fill="currentColor"
              className="w-8 h-8 text-accent-2"
            >
            ...
            <svg
              ...
              viewBox="0 0 512 512"
              fill="currentColor"
              className="absolute right-0 w-8 h-8 text-accent-2"
            >
        ...
        <div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-tertiary text-gray-50">
          {/* <img
          ...
          <p className="text-sm uppercase text-white">{testimonial.company}</p>
        </div>
      </div>
    </>
  );
